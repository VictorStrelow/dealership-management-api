...
@Schema(description = "Dados para cadastro ou atualização de um carro")
public record CarroRequestDTO(

        @Schema(description = "Marca do carro", example = "Toyota", minLength = 2, maxLength = 50)
        @NotBlank(message = "A marca é obrigatória!")
        @Size(min = 2, max = 50, message = "A marca deve ter entre 2 e 50 caracteres.")
        String marca,

        @Schema(description = "Modelo do carro", example = "Hilux", minLength = 1, maxLength = 100)
        ...
        @Schema(description = "Preço do carro em reais", example = "129890.00", minimum = "0.01")
        ...
        @Schema(description = "Tipo de combustível do carro", example = "FLEX",
